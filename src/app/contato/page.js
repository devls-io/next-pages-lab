  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-8 flex items-center justify-center transition-colors duration-300">
      ...
      <main className="bg-white dark:bg-gray-900 p-8 md:p-12 rounded-2xl shadow-2xl max-w-lg w-full text-center border border-gray-100 dark:border-gray-800 transition-all hover:shadow-[0_0_30px_rgba(59,130,246,0.1)]">
        ...
        {/* Título */}
        <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-2">Quem sou eu?</h1>
        ...
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
          Sou estudante de Análise e Desenvolvimento de Sistemas apaixonado pelo Front-end. Focado
          em aprendizado contínuo e boas práticas. Atualmente estou mergulhando de cabeça no
          ecossistema do <strong>Next.js 16</strong> e construindo projetos modernos para web.
        </p>
